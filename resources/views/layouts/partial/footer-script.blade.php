	...
	<script src="{{ asset('vendor/assets/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js')}}"></script>
	<script src="{{ asset('vendor/assets/vendor/chartist/js/chartist.min.js')}}"></script>
	...
	<script src="{{asset('vendor/assets/js/demo/datatables-demo.js')}}"></script>
	<script>
	$(function() {
		var data, options;
